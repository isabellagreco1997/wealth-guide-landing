...
export const FormSpeechBubble = () => (
  <div className="relative hidden md:block">
    ...
    <img 
      ...
      className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 w-32 h-16 object-contain hidden md:block z-10 [filter:brightness(0)_saturate(100%)_invert(56%)_sepia(93%)_saturate(1944%)_hue-rotate(346deg)_brightness(99%)_contrast(96%)]"
    />
  </div>
);