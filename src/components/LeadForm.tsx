...
export const LeadForm = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="relative bg-[#9b87f5]/80 p-6 rounded-[20px] mb-8 text-center w-full max-w-md shadow-lg transform hover:scale-105 transition-transform duration-200 before:content-[''] before:absolute before:bottom-0 before:left-[48px] before:w-4 before:h-4 before:bg-[#9b87f5]/80 before:transform before:translate-y-1/2 before:rotate-45">
        <p className="text-lg md:text-xl font-playfair text-navy">
