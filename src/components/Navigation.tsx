  ...
  return (
    <nav className="w-full py-6 px-4 md:px-8 bg-[#1A1F2C]/95 backdrop-blur-sm fixed top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link to="/" className="group flex items-center space-x-3 text-2xl font-inter font-black text-white transition-all duration-300 hover:scale-105">
          ...
          <span className="relative">
            <span className="font-playfair italic">Retirement</span>
            <span className="text-[#F97316] font-playfair italic"> Scientist</span>
